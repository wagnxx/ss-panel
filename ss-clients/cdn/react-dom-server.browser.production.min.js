...
(function(k, p) {
  'object' === typeof exports && 'undefined' !== typeof module
    ...
    ? define(['react'], p)
    : ((k = k || self), (k.ReactDOMServer = p(k.React)));
})(this, function(k) {
  function p(a) {
    for (
  ...
  function ya(a, b, c, d) {
    if (null === b || 'undefined' === typeof b || xa(a, b, c, d)) return !0;
    if (d) return !1;
    if (null !== c)
      switch (c.type) {
        case 3:
  ...
  function na(a, b, c) {
    ...
    a =
      a === ma ? ('function' === typeof b ? b() : b) : void 0 !== c ? c(b) : b;
    e.memoizedState = a;
  ...
  var x = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,
    ...
    Z = l ? Symbol.for('react.suspense_list') : 60120,
  ...
  ['contentEditable', 'draggable', 'spellCheck', 'value'].forEach(function(a) {
    m[a] = new n(a, 2, !1, a.toLowerCase(), null, !1);
  });
  [
    'autoReverse',
    ...
    sa = (function() {
      function a(a, b) {
        k.isValidElement(a)
          ? a.type !== L
            ? (a = [a])
            : ((a = a.props.children), (a = k.isValidElement(a) ? [a] : B(a)))
          : (a = B(a));
        a = {
          type: null,
          ...
          for (var h = [''], v = !1; h[0].length < a; ) {
            ...
            if (v || f.childIndex >= f.children.length) {
              ...
              try {
                ...
                if (null != R && 'function' === typeof R.then)
                  throw Error(p(294));
                throw R;
              } finally {
              }
      ...
      b.render = function(a, b, g) {
        ...
        if ('object' === typeof c && null !== c)
          switch (c.$$typeof) {
            ...
            case ca:
              return (
                (a = [k.createElement(c.type, x({ ref: a.ref }, a.props))]),
                this.stack.push({
                  type: null,
                  domNamespace: g,
                  children: a,
            ...
            case da:
              switch (((c = a.type), ta(c), c._status)) {
                case 1:
                  return (
                    (a = [
                      k.createElement(c._result, x({ ref: a.ref }, a.props)),
                    ]),
                    this.stack.push({
                      type: null,
                      domNamespace: g,
      ...
      b.renderDOM = function(a, b, g) {
        ...
        if ('input' === c)
          ...
          if (null != f) {
            ...
            d = x({ selected: void 0, children: void 0 }, d, {
              selected: e,
              children: l,
            });
          }
        ...
        for (w in e)
          if (Qa.call(e, w)) {
            ...
            if (null != n) {
              ...
              k = null;
              b: if (((y = c), (r = e), -1 === y.indexOf('-')))
                y = 'string' === typeof r.is;
              else
                switch (y) {
                  case 'annotation-xml':
                  case 'color-profile':
        ...
        a: {
          ...
          if (null != f) {
            ...
            ((f = d.children), 'string' === typeof f || 'number' === typeof f)
          ) {
            f = C(f);
            break a;
          }
        ...
        a = a.type;
        g =
          null == g || 'http://www.w3.org/1999/xhtml' === g
            ? oa(a)
            : 'http://www.w3.org/2000/svg' === g && 'foreignObject' === a
