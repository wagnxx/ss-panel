...
var IndexPage = /** @class */ (function () {
    ...
    IndexPage.prototype.indexCase = function (ctx) {
    ...
    IndexPage = __decorate([
        ...
        (inversify_binding_decorators_1.fluentProvide(inversify_koa_utils_1.TYPE.Controller).whenTargetNamed('IndexPage').done())
    ], IndexPage);
    return IndexPage;
}());
