...
var BaseTable = /** @class */ (function (_super) {
     ...
     * @param item 新项目
     */
    BaseTable.createItem = function (item) {
     ...
     * @param id
     */
    BaseTable.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @param id 需要修改的项目id
     */
    BaseTable.updateItemById = function (item, id) {
        return __awaiter(this, void 0, void 0, function () {
            var objItem, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * 查询所有
     */
    BaseTable.getList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var items;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAll({ raw: true })];
                    case 1:
                        items = _a.sent();
